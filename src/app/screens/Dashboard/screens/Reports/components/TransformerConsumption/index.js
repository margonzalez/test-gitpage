...
class TransformerConsumption extends PureComponent {
        ...
        <div className={styles.fieldsContainer}>
          <div className={styles.textField}>
            <Field
              ...
              placeholder="Ingrese el id del transformador"
...
TransformerConsumption.propTypes = {
  handleSubmit: func,
  submit: func
};

export default reduxForm({ form: 'TRANSFORMER_CONSUMPTION' })(TransformerConsumption);
