...
module.exports = function override(config, env) {
  ...
  const { baseConfig, ignore, useEslintrc, ...restOptions } = eslintRule.options;
  ...
  utils.addBeforeRule(config.module.rules, fileLoaderMatcher, loaders.scssModules);
  utils.addBeforeRule(config.module.rules, fileLoaderMatcher, loaders.cssModules);
